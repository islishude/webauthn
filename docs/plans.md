...
| 05    | [Modular attestation formats](plans/05-attestation-formats.md)                     | P1       | In progress, 2026-05-31      | Implement optional attestation formats; `none`, initial `packed`, and initial `fido-u2f` verifiers are delivered. |
