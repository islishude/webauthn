...
2026-06-01 Level 3 update: Plan 13 adds optional `attestation/compound`
and compound statement normalization in `codec/cbor`. Plan 05 remains the
Level 2 format baseline; compound attestation is tracked by Plan 13.
