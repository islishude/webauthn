...
| Attestation format packages | `none`, `packed`, `tpm`, `android-key`, `android-safetynet`, `fido-u2f`, `apple`                        | `none`, `packed`, `tpm`, `android-key`, and `fido-u2f` implemented as optional imports; others future work |
...
6. modular attestation formats (in progress: `none`, `packed`, `tpm`, `android-key`, and `fido-u2f`);
7. extensions;
